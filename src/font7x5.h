...
const char font7x5_letters[] = {  
  ...
  0x00, 0x3C, 0x3C, 0x3C, 0x3C, // . (@) // big period
...
// complete CP437 (DOS Extended ASCII) encoded

/*
const char font7x5[] = {
  0x00, 0x00, 0x00, 0x00, 0x00,  // ASCII 0x00
  0x7C, 0xDA, 0xF2, 0xDA, 0x7C,  // ASCII 0x01
  ...
  0x00, 0x3C, 0x3C, 0x3C, 0x3C   // black square
};
*/
